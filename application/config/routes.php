...
//$route['australian-opal/(:any)'] = 'australian_opal/index/$1';
$route['search/(:any)'] = 'search/index/$1';
$route['product/(:any)'] = 'product/index/$1';
$route['home'] = 'home/index';
$route['forgotten'] = 'forgotten/index';
$route['forgotten/(:any)'] = 'forgotten/$1';
$route['contact/(:any)'] = 'contact/$1';
$route['contact/(:any)/(:any)'] = 'contact/$1/$2';
$route['contact/(:any)/(:any)/(:any)'] = 'contact/$1/$2/$3';
$route['checkout/paypal/notify'] = 'checkout/paypal/notify';
