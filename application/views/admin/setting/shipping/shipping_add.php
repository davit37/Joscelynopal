    ...
    <div class="container-fluid">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo base_url('admin/setting/shipping/save') ?>" method="post" enctype="multipart/form-data" id="form-shipping" class="form-horizontal">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active in" id="tab-data">
                            <div class="form-group required <?php if($this->session->userdata('name_error')) echo 'has_error'; ?>">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="name" value="" placeholder="Shipping Name" id="input-name" class="form-control" />
