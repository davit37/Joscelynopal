    ...
    <div class="container-fluid">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo base_url('admin/catalog/category/update') ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active in" id="tab-data">
                            <div class="form-group required <?php if($this->session->userdata('category_error')) echo 'has_error'; ?>">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="category_name" value="<?php echo $result[0]['name'] ?>" placeholder="Category Name" id="input-name" class="form-control" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="category_description" placeholder="Description" id="input-description" class="form-control"><?php echo $result[0]['description'] ?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
