    ...
    <div class="container-fluid">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo base_url('admin/slideshow/save') ?>" method="post" enctype="multipart/form-data" id="form-slideshow" class="form-horizontal">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active in" id="tab-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="link" value="" placeholder="Link" id="input-link" class="form-control" />
                                </div>
                            </div>
