    ...
    <div class="page-header">
        <div class="container-fluid">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="<?php echo base_url('admin/page/payment-method') ?>">Payment Method</a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-pencil"></i> Edit Payment Method</h3>
            </div>
            <div class="panel-body">
                <form action="<?php echo base_url('admin/page/payment-method/update') ?>" method="post" enctype="multipart/form-data" id="form-payment" class="form-horizontal">
