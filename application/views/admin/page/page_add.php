    ...
    <div class="container-fluid">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-pencil"></i> Add Page</h3>
            </div>
            <div class="panel-body">
                <form action="<?php echo base_url('admin/page/save') ?>" method="post" enctype="multipart/form-data" id="form-page" class="form-horizontal">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active in" id="tab-data">
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="label_menu" value="" placeholder="Label Menu" id="input-label" class="form-control" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="description" placeholder="Description" id="input-description1"></textarea>
                                </div>
                            </div>
