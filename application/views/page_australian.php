<div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <img src="<?php echo base_url("assets/images/general/australian-opal.png") ?>" alt="Australian Opal" class="img-scale banner-shadow">
        </div>
    </div>
            ...
            foreach ($products as $product) {
                ...
                <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
                    <div class="product-item-wrap">
                        ...
                        <div class="product-title text-center"><a href="<?php echo base_url($this->uri->segment(1).'/'.$product['slug']); ?>"><?php echo $product['name'] ?></a></div>
                        <div class="item-desc text-center"><?php echo word_limiter($product['description'], 8); ?></div>
                        <div class="item-price text-center <?php echo ($product['special']) ? 'has-special' : ''; ?>">$<?php echo number_format($product['price'], 2, '.', '') ?></div>
...
<div id="popop-overlay-<?php echo $i ?>" class="overlay">
                        <div id="popup<?php echo $i ?>" class="popup-wrap">
                            ...
                            <div class="popup-inner-wrap">
                                ...
                                <div class="popup-price"><span class="<?php echo ($product['special']) ? 'has-special' : ''; ?>">$<?php echo number_format($product['price'], 2, '.', '') ?></span>
                                    <?php if ($product['special']) { ?>
                                        <span>$<?php echo number_format($product['special'], 2, '.', '') ?></span> save <?php
                                        $save = ($product['price'] - $product['special']) / $product['price'] * 100;
                                        echo number_format($save, 0, '.', '');
