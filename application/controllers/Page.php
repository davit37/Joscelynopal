...
class Page extends CI_Controller {
    ...
    public function index() {
        ...
        $query = "SELECT p.*, ps.price as special, ps.date_end FROM product p LEFT JOIN product_special ps ON p.product_id = ps.product_id ORDER BY p.featured DESC LIMIT 8";
